...
1.---Employees жадвалидан энг юқори 5 нафар ходимни танлаш учун сўров ёзинг
...
2.---Products жадвалида Category устуни бўйича такрорланмас (SELECT DISTINCT) қийматларни танланг.
...
3.---Products жадвалини Price > 100 бўлган товарларга фильтрлайдиган сўров ёзинг.

select *from products
where Price>100

4.---Customers жадвалидан FirstName ‘A’ ҳарфи билан бошланадиган мижозларни LIKE орқали танланг
...
5.---	Products натижасини Price бўйича ўсиш тартибда (ASC) тартибланг.
...
6.----Employees жадвалида Salary >= 60000 ва DepartmentName = 'HR' бўлган ходимларни WHERE билан фильтрланг.


select *from Employees
where DepartmentName like '[HR]%'

7.---Employees жадвалида Email устунидаги NULL қийматларни ISNULL орқали "noemail@example.com" матнига алмаштиринг
...
8.----Products жадвалидан Price BETWEEN 50 AND 100 бўлган товарларни танланг

select *from Products
where Price between 50 and 100

9.---Products жадвалида Category ва ProductName устунлари бўйича SELECT DISTINCT қўлланг
...
10.---9-бандидан кейинги натижани ProductName бўйича камайиш тартибда (DESC) тартибланг
...
1.---Products жадвалидан Price DESC тартибида TOP 10 махсулотни танланг
...
2.---Employees жадвалида COALESCE қўллаб FirstName ёки LastName’дан биринчиси NULL эмас қийматни қайтаринг
...
3.---Products жадвалида Category ва Price устунларини DISTINCT билан танланг
...
4.---Employees жадвалини шундай фильтрланг: Age 30–40 орасида ёки DepartmentName = 'Marketing'.

select*  from Employees
where Age  between 30 and 40 and DepartmentName = 'Marketing'

5.--Employees жадвалидан Salary DESC бўйича тартиблаб, OFFSET-FETCH орқали 11–20-қаторларни танланг
...
OFFSET 10 rows           -- 1–10 қаторни ўтказиб юборади
fetch next 10 rows only; -- кейинги 10 қатор: 11–20


6---Products жадвалидан Price <= 1000 ва StockQuantity > 50 бўлган товарларни танланг ва натижани Stock бўйича ўсиш тартибда тартибланг
...
7.--Products жадвалида ProductName ичида 'e' ҳарфи бор қийматларни LIKE билан фильтрланг

select*  from Products
where ProductName like '%e%'

8.---Employees жадвалида IN оператори орқали 'HR', 'IT', 'Finance' бўлимларида ишловчиларни танланг

select*  from Employees
where DepartmentName in ('HR', 'IT', 'Finance')

9.----	Customers жадвалида натижани City бўйича ўсиш (ASC) ва PostalCode бўйича камайиш (DESC) тартибида чиқаринг

select*  from Customers
order by City, PostalCode desc

-----Қийин даража топшириқлари----

1.---Sales маълумотлари бўйича энг юқори сотувга эга 5 та продуктни TOP(5) ва SaleAmount DESC тартибида танланг
...
2.---Employees жадвалида FirstName ва LastName ни қўшиб, FullName номли ягона устун сифатида (фақат SELECT ичида) кўрсатинг
...
3.---Products жадвалида DISTINCT(Category, ProductName, Price) қўллаб, $50 дан юқори баҳоли товарларни танланг.
...
4.---Products жадвалида нархи ўртача нархнинг 10%идан кам бўлган товарларни танланг (барча товарларнинг ўртача нархини топиш бўйича изланг).
...
5.--Employees жадвалида Age < 30 ва бўлими 'HR' ёки 'IT' бўлган ходимларни WHERE билан фильтрланг

select* from Employees 
where Age < 30 and DepartmentName in ('HR','IT')

6.---Customers жадвалидан Email ичида '@gmail.com' домени бор мижозларни LIKE билан танланг

select* from Customers 
where Email like '%@gmail.com%'

7.--ALL оператори орқали 'Sales' бўлимидаги барча ходимларнинг маошидан катта маошга эга ходимларни топинг
...
8.---Orders жадвалида сўнгги 180 кун ичида берилган буюртмаларни BETWEEN ва жадвалдаги LATEST_DATE устунидан фойдаланган ҳолда фильтрланг (жорий сана ва “энг сўнгги сана”ни олиш
