-----Осон даражадаги топшириқлар----

1.--Products жадвалида ProductName устунини alias орқали Name деб қайта номлаб оладиган сўров ёзинг
...
2.----Customers жадвалига alias бериб, уни Client деб атаб фойдаланинг
...
3.---	UNION қўллаб, икки сўров натижасини бирлаштиринг: бири Products’дан ProductName, иккинчиси Products_Discounted’дан ProductName танлайди 
...
4.---INTERSECT ёрдамида Products ва Products_Discounted жадваллари кесишувини (умумий қийматларини) топинг

select* from Products
intersect               
select* from Products_Discounted

5.---SELECT DISTINCT қўллаб, мижозларнинг (customer) уникал исм(лари) ва уларга мос Country ни танланг
...
6.--Products жадвалида CASE орқали шартли устун яратинг: Price > 1000 бўлса – ‘High’, акс ҳолда – ‘Low’ чиқсин.

select* from Products_Discounted

select
		*, case
			when Price <1000 then 'low' else 'High' end as SalesCategory
			from products


7.----Products_Discounted жадвалида IIF қўллансин: StockQuantity > 100 бўлса ‘Yes’, акс ҳолда ‘No’ чиқадиган устун яратинг

SELECT *,
       IIF(StockQuantity > 100, 'Yes', 'No') AS Over100
      FROM Products_Discounted

------Ўрта (Medium) даражадаги топшириқлар-------

1.---UNION қўллаб, Products’дан ProductName ва Products_Discounted’дан ProductName натижаларини бирлаштиринг

select ProductName from Products
union                
select ProductName from Products_Discounted

2.----EXCEPT ёрдамида Products ва Products_Discounted жадваллари орасидаги фарқни (Products’да бор, лекин Products_Discounted’да йўқ бўлганлар) қайтаринг

select* from Products
except                
select* from Products_Discounted

3.--Products жадвалида IIF билан шартли устун яратинг: Price > 1000 бўлса ‘Expensive’, акс ҳолда ‘Affordable’.

select* from Products

SELECT *,
       IIF(Price > 1000, 'Expensive', 'Affordable') AS price2
      FROM Products


4.--Employees жадвалида Age < 25 ёки Salary > 60000 шартидан камида биттасига мос келадиган ходимларни топинг
...
5.--Маошни янгилаш: Department’и 'HR' бўлган ёки EmployeeID = 5 бўлган ходимлар маошини 10% га оширинг

UPDATE e
SET e.Salary = CAST(e.Salary * 1.10 AS DECIMAL(10,2))
...
----Қийин (Hard) даражадаги топшириқлар----

1.---Sales жадвалида CASE орқали қуйидагича тоифалашни амалга оширинг: SaleAmount > 500 бўлса 'Top Tier', 200 ва 500 оралиғида бўлса 'Mid Tier', акс ҳолда 'Low Tier'.
...
select
		*, case
			...
			when Saleamount  between 200 and 500 then 'Mid Tier' else 'Low Tier' end as Customertype
			from sales

2----Буюртма берган, бироқ Sales жадвалида мос ёзуви мавжуд бўлмаган мижозларнинг ID ларини EXCEPT ёрдамида топинг
...
3---Orders жадвалидан фойдаланиб, харид қилинган миқдорга қараб чегирма фоизини аниқлайдиган CASE ифодасини ёзинг. Натижа тўпламида customerid, quantity ва discount (фоиз) кўрсатилиши керак. Чегирма қоидалари:
---1 та маҳсулот: 3%
---1 ва 3 оралиғида (яъни >1 ва ≤3): 5%
---Акс ҳолда: 7%
...
SELECT
    ...
    o.Quantity,
    CASE
        WHEN o.Quantity = 1 THEN 3          -- 1 та маҳсулот → 3%
        WHEN o.Quantity > 1 AND o.Quantity <= 3 THEN 5   -- (1, 3] → 5%
        ELSE 7                               -- акс ҳолда → 7%
