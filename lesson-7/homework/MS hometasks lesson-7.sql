----Осон даража (10 та)
1.---Products жадвалидаги маҳсулотларнинг энг кичик (MIN) нархини топинг.
...
2.----Employees жадвалидаги энг катта (MAX) ойликни топинг
...
3.---Customers жадвалидаги қаторлар сонини COUNT(*) билан сананг.
...
4.---Products жадвалидаги нотакрор тоифалар (категориялар) сонини сананг.
...
5.---Sales жадвалида id’си 7 бўлган маҳсулот учун жами сотув суммасини ҳисобланг.
...
6.--Employees жадвалида ходимларнинг ўртача ёшини ҳисобланг.

select* from Employees

SELECT avg(age) FROM Employees

7.---Ҳар бир бўлимдаги (department) ходимлар сонини сананг.

select DepartmentName, count(employeeid) from Employees
group by DepartmentName

8.--Products жадвали асосида тоифалар кесимида маҳсулотларнинг энг кичик ва энг катта нархини чиқаринг.
...
9.--Sales жадвалида ҳар бир мижоз (Customer) бўйича жами сотувни ҳисобланг

select CustomerID, sum(SaleAmount) as totalsales from Sales
group by CustomerID

10.---Employees жадвалида ходимлари сони 5 тадан кўп бўлган бўлимларни (DeptID бўлса кифоя, DeptName шарт эмас)
--HAVING билан фильтрланг.

select* from Employees

SELECT DepartmentName, COUNT(*) AS EmployeeCount
FROM Employees
WHERE EmployeeID IS NOT NULL            -- ихтиёрий: NULL бўлимларни чиқармаслик учун
GROUP BY DepartmentName
HAVING COUNT(*) > 5;
...
1.----Sales жадвалида ҳар бир маҳсулот тоифаси бўйича жами сотув ва ўртача сотувни ҳисобланг.

select ProductID, sum(SaleAmount) as totalsales, avg(Saleamount) as mediumsales from Sales
group by ProductID

2.----HR бўлимидаги ходимлар сонини сананг.

select count(*) as HR_EmployeeCount from Employees
where DepartmentName='HR'

3.---Employees жадвалида ҳар бир бўлим бўйича энг юқори ва энг паст ойликни аниқланг (DeptID бўлса кифоя).
...
4.---Ҳар бир бўлим бўйича ўртача ойликни ҳисобланг (DeptID бўлса кифоя).
...
5.---Ҳар бир бўлимдаги ходимлар учун ўртача ойлик (AVG) ва COUNT(*) ни кўрсатинг (DeptID бўлса кифоя).
...
6.---Ўртача нархи 400 дан катта бўлган маҳсулот тоифаларини фильтрланг.
...
7.---Sales жадвалида ҳар бир йил кесимида жами сотувни ҳисобланг.
...
8.--Камида 3 та буюртма берган мижозлар рўйхатини чиқаринг.
...
GROUP BY CustomerID
HAVING COUNT(*) >= 3
ORDER BY OrdersCount DESC, CustomerID;


9.---Ўртача иш ҳақи харажатлари 60000 дан катта бўлган бўлимларни фильтрлаб чиқаринг (DeptID бўлса кифоя).

SELECT 
    DepartmentName,
    AVG(Salary) AS AvgSalary
FROM Employees
WHERE Salary IS NOT NULL          -- ихтиёрий, хавфсизлик учун
GROUP BY DepartmentName
...
1.---Ҳар бир маҳсулот тоифаси бўйича ўртача нархни кўрсатинг ва ўртача нархи 150 дан катта бўлган
---тоифаларни HAVING билан фильтрланг.
...
2.---Ҳар бир мижоз бўйича жами сотувни ҳисобланг ва жами сотуви 1500 дан ошган мижозларнигина қолдиринг.
...
3.---Ҳар бир бўлим бўйича жами ва ўртача ойликни аниқланг, сўнг ўртача ойлиги 65000 дан катта бўлган бўлимларнигина чиқаринг.
...
4.---Ҳар бир мижоз учун ташиш тўлови (freight) $50 дан ортиқ бўлган буюртмаларнинг жами суммасини ва
---шу мижознинг энг кичик хариди (least purchase) ни кўрсатинг (энг кичик сумма $50 дан паст бўлиши мумкин). 
---Маълумот манбаси: tsql2012.sales.orders жадвали, freight устуни. (TSQL2012 маълумотлар базасини олиш учун 
--ассистентингиздан сўранг.)
...
CREATE TABLE Sales.OrderDetails (
    ...
    qty        INT            NOT NULL,
    discount   DECIMAL(5,4)   NOT NULL DEFAULT (0), -- masalan, 0.10 = 10%
    CONSTRAINT FK_OrderDetails_Orders
        FOREIGN KEY (orderid) REFERENCES Sales.Orders(orderid)
);

INSERT INTO Sales.Orders (orderid, custid, orderdate, freight) VALUES
(101, 1, '2023-01-05', 30.00),   -- < 50
(102, 1, '2023-01-10', 60.00),   -- > 50
(103, 2, '2023-01-12', 80.00),   -- > 50
(104, 2, '2023-01-15', 45.00),   -- < 50
(105, 3, '2023-01-20', 70.00),   -- > 50
(106, 3, '2023-01-25', 55.00),   -- > 50
(107, 2, '2023-02-01', 10.00),   -- < 50
(108, 1, '2023-02-05', 51.00);   -- > 50

-- Har bir buyurtmaga 1+ line qo‘yib, turli summalar hosil qilamiz
INSERT INTO Sales.OrderDetails (orderid, productid, unitprice, qty, discount) VALUES
-- order 101 (cust 1)  (freight 30)
(101, 1, 100.00, 1, 0.00),
-- order 102 (cust 1)  (freight 60)
(102, 2, 200.00, 2, 0.10),   -- 200*2*(1-0.1)=360
(102, 3,  50.00, 3, 0.00),   -- 150
-- order 103 (cust 2)  (freight 80)
(103, 4, 300.00, 1, 0.00),   -- 300
(103, 5,  40.00, 5, 0.05),   -- 40*5*(0.95)=190
-- order 104 (cust 2)  (freight 45)
(104, 6, 120.00, 1, 0.00),
-- order 105 (cust 3)  (freight 70)
(105, 7, 450.00, 1, 0.20),   -- 360
(105, 8,  25.00, 4, 0.00),   -- 100
-- order 106 (cust 3)  (freight 55)
(106, 9,  80.00, 2, 0.00),   -- 160
-- order 107 (cust 2)  (freight 10)
(107,10,  30.00, 3, 0.00),   -- 90
-- order 108 (cust 1)  (freight 51)
(108,11,  60.00, 1, 0.00);   -- 60

/* 4) So‘rov: har bir mijoz uchun
      - freight > 50 bo‘lgan buyurtmalar jami summasi
      - eng kichik xaridi (least purchase, mijozning eng arzon buyurtmasi summasi)
   Eslatma: LeastPurchase freight bilan cheklanmaydi (shartga ko‘ra past bo‘lishi mumkin) */
;WITH OrderTotals AS (
    SELECT 
        od.orderid,
        SUM(od.qty * od.unitprice * (1.0 - od.discount)) AS order_amount
...
SELECT
    ...
    SUM(CASE WHEN freight > 50 THEN order_amount ELSE 0 END) AS TotalAmount_FreightOver50,
    MIN(order_amount) AS LeastPurchase
FROM PerCustomer
GROUP BY custid
-- faqat freight>50 bo‘lganlari bor mijozlarni qoldirish:
HAVING SUM(CASE WHEN freight > 50 THEN order_amount ELSE 0 END) > 0
ORDER BY TotalAmount_FreightOver50 DESC, CustomerID;

5.--Ҳар бир йилнинг ҳар ойи кесимида жами сотувни ҳисобланг ва шу ойда сотилган нотакрор маҳсулотлар сонини сананг; 
--кейин камида 2 та маҳсулот сотилган ойларни қолдиринг (Orders).
...
6.--Orders жадвали асосида йиллар кесимида минимал ва максимал буюртма миқдорини (quantity) топинг.
