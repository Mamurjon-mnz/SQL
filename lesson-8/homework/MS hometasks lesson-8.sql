----Осон даражадаги вазифалар----

1.---Products жадвали асосида ҳар бир тоифада мавжуд маҳсулотлар сонини топинг.
...
2.--Products жадвали асосида 'Electronics' тоифасидаги маҳсулотларнинг ўртача нархини олинг.

select category, avg(price) as avg_electronics from Products
where category= 'Electronics'
group by category

3.--Customers жадвали асосида номи 'L' ҳарфи билан бошланадиган шаҳарлардан бўлган барча мижозларни рўйхатга олинг.
...
4.----Products жадвали асосида номи 'er' билан тугайдиган барча маҳсулот номларини олинг.

select *from Products
where ProductName like '%er'

5.----Customers жадвали асосида номи 'A' ҳарфи билан тугайдиган давлатлардан бўлган барча мижозларни рўйхатга олинг.

select *from Customers
where state like '%A'

6.---Products жадвали асосида барча маҳсулотлар орасидаги энг юқори нархни кўрсатинг.

SELECT MAX(Price) AS MaxPrice
FROM Products;

7.---Products жадвали асосида омбор миқдорини баҳоланг: агар quantity < 30 бўлса 'Low Stock', акс ҳолда 'Sufficient' деб белгиланган ҳолда чиқаринг.

select *from Products

select
		*, case
			when StockQuantity<30 then 'Low Stock' else 'Sufficient' end as QuantityCategory
from products
			

8.---Customers жадвали асосида ҳар бир мамлакатдаги мижозлар сонини топинг

select state, count(*) from Customers
group by state


9.---Orders жадвали асосида буюртма қилинган миқдор (Quantity) бўйича минимал ва максимал қийматларни топинг.
...
select  max(quantity) as max_quantity, min(quantity) as min_quantity from orders
 ...
 ----Ўрта даражадаги вазифалар----

--10.----Orders ва Invoices жадвалларидан фойдаланиб, 2023 йил январ ойида буюртма берган, аммо инвойси йўқ бўлган мижозларни аниқлаш учун уларнинг CustomerID ларини рўйхатга олинг.
...
---11.Products ва Products_Discounted жадвалларидан фойдаланиб, иккаласидаги барча маҳсулот номларини такрорларини ҳам қўшган ҳолда (duplicates’ни сақлаган ҳолда) бирлаштиринг.
...
ORDER BY ProductName;  -- ixtiyoriy

---12. Products ва Products_Discounted жадвалларидан фойдаланиб, маҳсулот номларини такрорланмайдиган тарзда (duplicates’сиз) бирлаштиринг
...
---13. Orders жадвали асосида йиллар кесимида ўртача буюртма суммасини топинг.

SELECT orderdate, avg(Totalamount) as avg_orderamount from orders
group by orderdate

----14. Products жадвали асосида маҳсулотларни нархига кўра гуруҳланг: 'Low' (<100), 'Mid' (100–500), 'High' (>500). Natijada productname ва pricegroup ни қайтаринг.

select productname,
		 case
			when price<100 then 'low'
			when price between 100 and 200 then 'Mid' else 'High' end as pricegroup
from products

----15. City_Population жадвалида Pivot қўллаб Year устуни қийматларини алоҳида устунларга чиқаринг ([2012], [2013]) ва натижани Population_Each_Year номли янги жадвалга нусха қилиб сақланг
...
IF OBJECT_ID('dbo.Population_Each_Year','U') IS NOT NULL
    DROP TABLE dbo.Population_Each_Year;

-- PIVOT bilan yaratish
SELECT
    district_id,
    district_name,
    [2012],
...
FROM (
    SELECT 
        ...
        district_name,
        population,
        CONVERT(int, [year]) AS YearInt
    FROM dbo.city_population
) AS src
PIVOT (
    SUM(population) FOR YearInt IN ([2012], [2013])
) AS p;

-- Tekshirish
SELECT * FROM dbo.Population_Each_Year ORDER BY district_id;

---16. Sales жадвали асосида ҳар бир ProductID бўйича жами сотувларни (total sales) топинг.

select ProductID, sum(saleamount) as total_sales from Sales
group by ProductID

---17. Products жадвалида wildcard (қидирув ниқоблари) орқали номи ичида 'oo' қатори бор маҳсулотларни топинг. productname ни қайтаринг.
...
-----18. City_Population жадвалида Pivot қўллаб City устуни қийматларини алоҳида устунларга чиқаринг (Bektemir, Chilonzor, Yakkasaroy) ва натижани Population_Each_City номли янги жадвалга нусха қилиб сақланг.

IF OBJECT_ID('dbo.Population_Each_City','U') IS NOT NULL
    DROP TABLE dbo.Population_Each_City;
...
-- Natijani ko'rish
SELECT * FROM dbo.Population_Each_City ORDER BY [Year];


-----Қийин даражадаги вазифалар-----

----19. Invoices жадвали асосида жами инвойс суммаси энг юқори бўлган топ-3 мижозни кўрсатинг. CustomerID ва TotalSpent ни қайтаринг.
...
FROM Invoices
GROUP BY CustomerID
ORDER BY SUM(TotalAmount) DESC, CustomerID ASC;  -- ixtiyoriy ikkinchi tartib

----20. Population_Each_Year жадвалини аввалги асл кўринишга (City_Population) қайта трансформация қилинган ҳолатга келтиринг.

----Asl City_Population tuzilmasiga mos chiqish
SELECT 
    district_id,
    district_name,
    CAST(population AS decimal(10,2)) AS population,
    CAST([Year] AS varchar(20))       AS [year]
...
---21. Products ва Sales жадвалларидан фойдаланиб, маҳсулот номлари ва ҳар бири неча марта сотилганини чиқаринг. (Join’ларни ўрганиш тавсия этилади.)

----A) Faqat sotilganlar (kamida 1 marta) — INNER JOIN
SELECT 
    p.ProductName,
...
----B) Barcha mahsulotlar (sotilmaganlar ham 0 bilan) — LEFT JOIN (tavsiya)
SELECT 
    p.ProductName,
    COUNT(s.SaleID) AS TimesSold
FROM Products AS p
...
----22. Population_Each_City жадвалини аввалги асл кўринишга (City_Population) қайта трансформация қилинган ҳолатга келтиринг

----Variant A — UNPIVOT + mapping (ixcham)
-- (Ixtiyoriy) avvaldan bo'lsa, o'chirib yuboramiz
IF OBJECT_ID('dbo.City_Population_Restored','U') IS NOT NULL
    DROP TABLE dbo.City_Population_Restored;
...
SELECT 
    M.district_id,
    U.district_name,
    CAST(U.population AS decimal(10,2)) AS population,
    U.[year]
INTO dbo.City_Population_Restored
FROM U
JOIN (VALUES
    ('Bektemir',   5),
    ('Chilonzor',  1),
    ('Yakkasaroy', 2)
) AS M(district_name, district_id)
  ON M.district_name = U.district_name
WHERE U.population IS NOT NULL;

SELECT * FROM dbo.City_Population_Restored
ORDER BY district_id, [year];

-----Variant B — CROSS APPLY VALUES + mapping (o‘qilishi juda oson)
IF OBJECT_ID('dbo.City_Population_Restored','U') IS NOT NULL
    DROP TABLE dbo.City_Population_Restored;
...
SELECT
    M.district_id,
    V.district_name,
    CAST(V.population AS decimal(10,2)) AS population,
    CAST(C.[Year] AS varchar(20)) AS [year]
INTO dbo.City_Population_Restored
FROM dbo.Population_Each_City AS C
CROSS APPLY (VALUES
    ('Bektemir',   C.[Bektemir]),
    ('Chilonzor',  C.[Chilonzor]),
    ('Yakkasaroy', C.[Yakkasaroy])
) AS V(district_name, population)
JOIN (VALUES
    ('Bektemir',   5),
    ('Chilonzor',  1),
    ('Yakkasaroy', 2)
) AS M(district_name, district_id)
  ON M.district_name = V.district_name
