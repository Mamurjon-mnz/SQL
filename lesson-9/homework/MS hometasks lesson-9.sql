...
-----Осон даража (10 та)---
1.----Products, Suppliers жадвалларидан фойдаланиб барча маҳсулот номлари ва етказиб берувчи номларининг барча комбинациялари ни чиқаринг.
...
---2.	Departments, Employees жадвалларидан фойдаланиб бўлимлар ва ходимларнинг барча комбинациялари ни олинг.
...
LEFT JOIN Employees AS e
    ON 1 = 1      -- ҳар бир бўлим ҳар бир ходим билан жуфтланади
ORDER BY d.DepartmentName, e.EmployeeID;

-----3.	Products, Suppliers жадвалларидан фойдаланиб фақат етказиб берувчи ушбу маҳсулотни ҳақиқатдан ҳам етказиб берган ҳолатлар ни рўйхат қилинг. 
----SupplierName ва ProductName ни қайтаринг.
...
------4.	Orders, Customers жадвалларидан фойдаланиб мижоз номлари ва уларнинг OrderID ларини кўрсатинг.
...
ORDER BY CustomerName, o.OrderID;

-----5.	Courses, Students жадвалларидан фойдаланиб ўқувчилар ва курслар нинг барча комбинацияларини чиқаринг.
...
----6.	Products, Orders жадвалларидан фойдаланиб ProductID лар тўғри келган ҳолатдаги маҳсулот номлари ва буюртмаларни олинг.
...
----7.	Departments, Employees жадвалларидан фойдаланиб Employee.DepartmentID бўлим билан мос тушадиган ходимларни рўйхат қилинг.
...
-------8.	Students, Enrollments жадвалларидан фойдаланиб талаба номлари ва уларнинг Enrollments.CourseID ларини кўрсатинг.
...
ORDER BY s.StudentID, e.CourseID;


---9.	Payments, Orders жадвалларидан фойдаланиб мувофиқ келган тўловга эга барча буюртмалар ни рўйхат қилинг.
...
--10.	Orders, Products жадвалларидан фойдаланиб ProductPrice > 100 бўлган буюртмаларни кўрсатинг.
...
----1.	Employees, Departments жадвалларидан фойдаланиб DepartmentID лари тенг бўлмаган ҳолатларни чиқаринг: яъни номос (мувофиқ келмаган) ходим-бўлим жуфтликларини кўрсатинг.
...
----2.	Orders, Products жадвалларидан фойдаланиб OrderedQuantity > StockQuantity бўлган буюртмаларни кўрсатинг.

SELECT
    o.OrderID, o.OrderDate, o.Quantity, o.TotalAmount,
...
----3.	Customers, Sales жадвалларидан фойдаланиб SaleAmount ≥ 500 бўлган ҳолларда CustomerName ва ProductID ни рўйхат қилинг.
...
ORDER BY CustomerName, s.ProductID;


--4.Courses, Enrollments, Students жадвалларидан фойдаланиб талаба исмлари ва улар роʻйхатдан ўтган курс номлари ни чиқаринг.
...
----5.	Products, Suppliers жадвалларидан фойдаланиб SupplierName ида “Tech” сўзи учраган маҳсулот-таъминотчи жуфтликларини кўрсатинг.
...
---6.	Orders, Payments жадвалларидан фойдаланиб PaymentAmount < TotalAmount бўлган буюртмаларни кўрсатинг.
...
ORDER BY o.OrderID, pmt.PaymentID;


----7.	Employees ва Departments жадвалларидан фойдаланиб ҳар бир ходим учун унинг бўлими номи ни олинг.
...
----8.	Products, Categories жадвалларидан фойдаланиб категорияси 'Electronics' ёки 'Furniture' бўлган маҳсулотларни кўрсатинг.
...
------9.	Sales, Customers жадвалларидан фойдаланиб 'USA' давлатидан бўлган мижозларнинг барча сотувларини кўрсатинг.
...
----10.	Orders, Customers жадвалларидан фойдаланиб 'Germany' дан бўлган мижозлар томонидан берилган ва OrderTotal > 100 бўлган буюртмаларни рўйхат қилинг.
...
------Қийин даража (5 та) (қуйидаги вазифалар учун бираз тадқиқот қилинг)---

----1.	Employees жадвалида турли бўлимлардан бўлган барча ходим жуфтлиги ни (бир-биридан фарқли DepartmentID) чиқаринг.

SELECT
    e1.EmployeeID AS Emp1ID,
    e1.Name       AS Emp1Name,
    e1.DepartmentID AS Emp1Dept,
    e2.EmployeeID AS Emp2ID,
    e2.Name       AS Emp2Name,
    e2.DepartmentID AS Emp2Dept
FROM Employees AS e1
INNER JOIN Employees AS e2
    ON e1.EmployeeID < e2.EmployeeID      -- бир жуфтликни бир марта
   AND e1.DepartmentID <> e2.DepartmentID; -- бўлимлари турлича


----2.	Payments, Orders, Products жадвалларидан фойдаланиб PaidAmount ≠ (Quantity × ProductPrice) бўлган тўлов тафсилотларини рўйхат қилинг.
...
----3.	Students, Enrollments, Courses жадвалларидан фойдаланиб ҳеч қайси курсга рўйхатдан ўтмаган талабалар ни топинг.
...
----4.	Employees жадвалида кимнингдир менежери бўлган, аммо маоши бошқарувидаги ходим маошидан кам ёки тенг бўлган менежерларни аниқланг.
...
ORDER BY mgr.EmployeeID, emp.EmployeeID;




------5.	Orders, Payments, Customers жадвалларидан фойдаланиб буюртма берган, лекин унга тўлов қайд этилмаган мижозлар ни рўйхат қилинг.
